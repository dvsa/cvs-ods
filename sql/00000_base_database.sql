...
(
    ...
    `frontVehicleTo5thWheelCouplingMin`   MEDIUMINT UNSIGNED,
    `frontVehicleTo5thWheelCouplingMax`   MEDIUMINT UNSIGNED,
...
(
    ...
    `testTypeStartTimestamp`            DATETIME(3),
    `testTypeEndTimestamp`              DATETIME(3),
    ...
    `reasonForAbandoning`               VARCHAR(1200),
    ...
    INDEX `idx_test_result_id` (`testResultId` ASC),
